...
public class MiniBug : CharacterBase
{
    ...
    {
        base.OnEnable();
        _maxHealth = Settings.Instance.SmallBugHealth;
        CurrentHealth = _maxHealth;
        MyDamage = Settings.Instance.SmallBugDamage;
        NavMeshAgent.speed = Settings.Instance.SmallBugSpeed;
    }
}