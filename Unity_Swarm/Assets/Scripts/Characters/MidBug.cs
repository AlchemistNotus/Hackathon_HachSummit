...
public class MidBug : CharacterBase
{
    ...
    {
        base.OnEnable();
        _maxHealth = Settings.Instance.MidBugHealth;
        CurrentHealth = _maxHealth;
        MyDamage = Settings.Instance.MidBugDamage;
        NavMeshAgent.speed = Settings.Instance.MidBugSpeed;
    }
}